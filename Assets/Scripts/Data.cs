...
public static class Data
{
    ...
    public static readonly Dictionary<Tetromino, Vector2Int[]> Cells = new Dictionary<Tetromino, Vector2Int[]>()
    {
        ...
        { Tetromino.S, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( 1, 0), new Vector2Int(-1,-1), new Vector2Int( 0,-1) } },
        { Tetromino.T, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int(-1, 0), new Vector2Int( 0,-1), new Vector2Int( 1, 0) } },
        { Tetromino.Z, new Vector2Int[] { new Vector2Int(-1, 0), new Vector2Int( 0, 0), new Vector2Int( 0,-1), new Vector2Int( 1,-1) } },
    };
